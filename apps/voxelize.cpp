...
//! [Usage]
          ...
          "- Compartment reports:\n"
          "    fivox[compartments]:///BlueConfig?dt=float,report=string,target=string[ or #target]\n"
          "- Soma reports:\n"
          "    fivoxsomas:///BlueConfig?dt=float,report=string,target=string[ or #target]\n"
          "- Spike reports:\n"
          "    fivoxspikes:///BlueConfig?dt=float,duration=float,spikes=path,target=string[ or #target]\n"
          "- Synapse densities:\n"
          "    fivoxsynapses:///BlueConfig,target=string[ or #target]\n"
          "- Voltage-sensitive dye reports:\n"
          "    fivoxvsd:///BlueConfig?dt=float,dyecurve=string,target=string[ or #target]\n"
          ...
          "a parameter will be deprecated\n"
          "\n"
          "Parameters:\n"
