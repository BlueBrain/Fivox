...
common_package(ITK 4.0  QUIET)
if(NOT ITK_FOUND AND NOT ITK_FOUND)
  set(FIND_REQUIRED_FAILED "${FIND_REQUIRED_FAILED} ITK")
endif()
common_package(Boost 1.41.0 COMPONENTS unit_test_framework program_options system QUIET)
